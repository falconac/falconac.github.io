...
(function(e, t) {
    ...
    function y(n, r, i) {
        if (i == t) i == 80;
        setTimeout(function() {
            n.find("http://wzfavored.com/themes/simpleboot3/portal/static/js/.slotholder .slot").each(function() {
                ...
                o.find(".tp-caption iframe").each(function() {
                    try {
                        if (e(this).attr("src").indexOf("you") > 0) {
                            ...
                            t.src = "player_api"/*tpa=http://wzfavored.com/themes/simpleboot3/www.youtube.com/player_api*/;
                ...
                o.find(".tp-caption iframe").each(function() {
                    try {
                        if (e(this).attr("src").indexOf("vim") > 0) {
                            var t = document.createElement("script");
                            t.src = "froogaloop2.min.js"/*tpa=http://wzfavored.com/themes/simpleboot3/a.vimeocdn.com/js/froogaloop2.min.js*/;
                            var n = document.getElementsByTagName("script")[0];
                            n.parentNode.insertBefore(t, n)
                        }
                    } catch(r) {}
